  ...
  return (
    <Layout showNav={false}>
      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden bg-background">
        ...
        {/* Main hero content */}
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 py-12 text-center gap-8">
          <motion.div
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-semibold font-body">
              🎉 Now open for all players
            </div>

            <h1 className="text-6xl md:text-8xl font-display font-extrabold text-foreground leading-none tracking-tight">
              Board
              <span
            ...
            <p className="max-w-md text-lg md:text-xl text-muted-foreground font-body leading-relaxed">
              The fast, colorful, wildly fun multiplayer board game. Roll the
              dice. Buy everything. Bankrupt your friends. 🎩
            </p>
          </motion.div>
          ...
          >
            ...
            <Link
              ...
              data-ocid="cta-join"
            >
              <span className="flex items-center gap-2">🎮 Join Game</span>
            </Link>
          </motion.div>
          ...
          >
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-card">
              ...
              />
              {/* Floating badges */}
              <div className="absolute top-4 left-4 bg-card/90 backdrop-blur-sm rounded-xl px-3 py-1.5 text-sm font-display font-bold text-foreground shadow-md border border-border">
                2–8 Players 🎯
              </div>
              <div className="absolute top-4 right-4 bg-primary/90 backdrop-blur-sm rounded-xl px-3 py-1.5 text-sm font-display font-bold text-primary-foreground shadow-md">
                Play Online 🌐
              </div>
            </div>
          </motion.div>
      ...
      <section className="bg-muted/30 py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            Everything you love about board games 🎊
          </motion.h2>
      ...
      <section className="bg-background py-20 px-6 text-center">
        ...
        >
          ...
          <p className="text-muted-foreground font-body">
            Gather your friends and start a game in under a minute.
          </p>
          <Link
            to="/lobby/create"
